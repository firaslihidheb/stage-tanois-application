...
CREATE TABLE `user` (
                        ...
                        PRIMARY KEY (`id`),
                        UNIQUE KEY `emailc_UNIQUE` (`email`),
...
CREATE TABLE `invoice_contract` (
                                   ...
                                   PRIMARY KEY (`id`),
                                   UNIQUE KEY `uq_inv_id_prod_id` (`invoice_id`,`contract_id`),
                                   ...
                                   CONSTRAINT `fk_contract_id` FOREIGN KEY (`contract_id`) REFERENCES `contract` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
