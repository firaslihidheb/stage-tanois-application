...
- Storing / Viewing contracts & clients and linking them
...
- Gmail API Integaration (Sending invoice to the client email via button click)
...
#### Working on Contraction environment Environment
